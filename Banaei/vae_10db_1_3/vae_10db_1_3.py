...
chckpnt = keras.callbacks.ModelCheckpoint(save_directory + '/vae_10db_1_3_weights.{epoch}-{val_PSNR:.2f}.h5',
                                                    monitor='val_PSNR', verbose=0, save_best_only=False,
                                                    save_weights_only=True, mode='auto', period=100)
csv = keras.callbacks.CSVLogger(save_directory + '/vae_10db_1_3.log', separator=',', append=True)
